                    ...
                    <form className='space-y-4' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className='flex items-center justify-between rounded-lg border p-3'>
                            ...
                            <Switch
                                ...
                                className="bg-gray-300 data-[state=checked]:bg-green-600 transition-colors"
                            />
                        ...
                        <div className='flex gap-4 pt-4'>
                            ...
                            <Button
                                ...
                                className="flex-1 bg-green-600 text-white hover:bg-green-700 disabled:opacity-50 transition-colors"
                            >
